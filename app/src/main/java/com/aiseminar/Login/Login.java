...
public class Login extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            startActivity(new Intent(this, com.aiseminar.platerecognizer.ui.CameraActivity.class));
            finish();
        }
    ...
    class OnlineCredentialValidation extends AsyncTask<String, Void, Integer> {
        ...
        protected void onPostExecute(Integer mFeedback) {
            ...
            if (mFeedback == feedback.SUCCESS) {
                ...
                Intent intent = new Intent(getApplication(), com.aiseminar.platerecognizer.ui.CameraActivity.class);
